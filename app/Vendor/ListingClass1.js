                        ...
                        <View style={{ marginHorizontal: 16, }}>
                            ...
                            >
                                <TextareaInput value={description}
                                    onChangeText={(text) => setDescription(text)} style={{ borderRadius: 12, borderWidth: 1, paddingHorizontal: 12, fontSize: 13, borderColor: '#C6C9D2', color: 'black' }} placeholder="What will students learn? Mention skills, levels, and outcomes." />
                            </Textarea>
