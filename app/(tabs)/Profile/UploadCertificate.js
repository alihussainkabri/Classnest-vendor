...
const UploadCertificate = ({ navigation }) => {
    ...
    const openCamera = async () => {
     ...
     async function create() {
            ...
            const response = await fetch(url + "add-certificate",{
                method : 'POST',
                headers : {
            ...
            <View style={{ flex: 1, justifyContent: 'space-between' }}>
                <ScrollView showsVerticalScrollIndicator={false}>
                    <View style={{ marginHorizontal: 16, }}>
                        ...
                        <Text style={{ color: '#17181C', fontFamily: fonts.IntSB, fontSize: 18, marginTop: 30 }}>Upload Certificate Images </Text>
                        ...
                        <TouchableOpacity onPress={() => setShowModal(true)} style={styles.uploadImgCard}>
                            ...
                            <Text style={{ fontFamily: fonts.IntMed, fontSize: 11, color: '#9DA2A6' }}>JPG, PNG or WEBP</Text>
                        </TouchableOpacity>
